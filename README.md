<p align="center">
  <img src="https://raw.githubusercontent.com/everruns/tuika/v0.12.0/logo.svg" width="144" alt="tuika logo: two offset rounded interface panels intersect at a gold anchor point">
</p>
...
[Website](https://tuika.dev) · [Rust API](https://docs.rs/tuika) · [Getting started](https://github.com/everruns/tuika/blob/v0.12.0/docs/getting-started.md) · [Components](https://github.com/everruns/tuika/blob/v0.12.0/docs/components.md) · [Layout](https://github.com/everruns/tuika/blob/v0.12.0/docs/layout.md) ·
[Markdown](https://github.com/everruns/tuika/blob/v0.12.0/docs/markdown.md) · [Charts](https://github.com/everruns/tuika/blob/v0.12.0/docs/charts.md) ·
[Terminal features](https://github.com/everruns/tuika/blob/v0.12.0/docs/features.md) ·
[Keymap](https://github.com/everruns/tuika/blob/v0.12.0/docs/keymap.md) · [Input routing](https://github.com/everruns/tuika/blob/v0.12.0/docs/routing.md) ·
[Styling](https://github.com/everruns/tuika/blob/v0.12.0/docs/styling.md) ·
[Themes](https://github.com/everruns/tuika/blob/v0.12.0/docs/themes.md) \
[Showcases](https://github.com/everruns/tuika/blob/v0.12.0/docs/showcases.md) · [Examples](#runnable-examples) ·
...
### tuika's goal is to become the default TUI [application](https://github.com/everruns/tuika/blob/v0.12.0/docs/showcases.md) framework for Rust
...
- **A whole app, not a widget set** — [flexbox layout](#model), anchored
  ...
  [keymap](https://github.com/everruns/tuika/blob/v0.12.0/docs/keymap.md), [themes and stylesheets](#theming), and a
...
- **Batteries the terminal era expects** — [30+ components](#components)
  including streaming [Markdown](https://github.com/everruns/tuika/blob/v0.12.0/docs/markdown.md) with pluggable syntax
  highlighting, [images](#images) over Kitty/iTerm2/Sixel, adaptive
  [charts](https://github.com/everruns/tuika/blob/v0.12.0/docs/charts.md), mermaid diagrams,
...
See what that buys in practice: the [showcases](https://github.com/everruns/tuika/blob/v0.12.0/docs/showcases.md) are
...
- **Layout** is an [integer-native flexbox subset](https://github.com/everruns/tuika/blob/v0.12.0/docs/layout.md) (`layout`): wrapped flex lines,
...
- **Keymap** ([`keymap`](https://github.com/everruns/tuika/blob/v0.12.0/docs/keymap.md)) resolves declarative key bindings to
  ...
  [keymap guide](https://github.com/everruns/tuika/blob/v0.12.0/docs/keymap.md).
- **Input routing** ([`routing`](https://github.com/everruns/tuika/blob/v0.12.0/docs/routing.md)) delivers an event to the
  ...
  [routing guide](https://github.com/everruns/tuika/blob/v0.12.0/docs/routing.md).
...
See the [component gallery](https://github.com/everruns/tuika/blob/v0.12.0/docs/components.md) for an animated demo of each
component. Linked names below jump straight to their demo.

| Component | Purpose |
| --- | --- |
| [`Text`](https://github.com/everruns/tuika/blob/v0.12.0/docs/components/text.md#text) / `Paragraph` | Literal styled lines / word-wrapped prose with bare web links |
| `Wrap` | Word-wraps pre-styled lines, preserving per-span styles |
| [`Markdown`](https://github.com/everruns/tuika/blob/v0.12.0/docs/markdown.md) (+ `MarkdownState`) | CommonMark → styled lines; `MarkdownState` streams incrementally — see the [markdown guide](https://github.com/everruns/tuika/blob/v0.12.0/docs/markdown.md) |
| [`CodeBlock`](https://github.com/everruns/tuika/blob/v0.12.0/docs/components/markdown-code.md#codeblock) | Themed, framed code block with a pluggable `Highlighter` and optional line-number gutter |
| [`Html`](https://github.com/everruns/tuika/blob/v0.12.0/docs/components/markdown-code.md#html) | HTML fragment → styled lines (companion crate [`tuika-html`](crates/tuika-html/)) |
...
| [`Rule`](https://github.com/everruns/tuika/blob/v0.12.0/docs/components/text.md#rule) | Horizontal separator: optional title + fill glyph to width |
| [`Flex`](https://github.com/everruns/tuika/blob/v0.12.0/docs/components/layout.md#flex) | Flexbox container (the composition primitive) |
| [`Flow`](https://github.com/everruns/tuika/blob/v0.12.0/docs/components/layout.md#flow) | Intrinsic-width items wrapped into flex lines |
| [`Grid`](https://github.com/everruns/tuika/blob/v0.12.0/docs/components/layout.md#grid) | Small equal-column, row-major terminal grid |
| `Responsive` / `Constrained` | Breakpoint selection and min/max measurement |
| [`Boxed`](https://github.com/everruns/tuika/blob/v0.12.0/docs/components/layout.md#boxed) | Border + padding + title, focus-aware |
| `Scene` / `ScopedScene` / `Dialog` | Owned or frame-borrowed root + anchored overlays |
| [`ConfirmDialog`](https://github.com/everruns/tuika/blob/v0.12.0/docs/components/interactive.md#dialog-presets) / `ChoiceDialog` / `MultiChoiceDialog` / `InputDialog` | Stateful presets for common modal flows |
| `Spacer` | Flexible filler |
| [`Scroll`](https://github.com/everruns/tuika/blob/v0.12.0/docs/components/interactive.md#scroll--scrollstate) (+ `ScrollState`) | Vertical scroll viewport + scrollbar over lines |
| [`ItemScroll`](https://github.com/everruns/tuika/blob/v0.12.0/docs/components/interactive.md#itemscroll) | The same viewport over laid-out items (panels, tables, nested layouts) |
| `Viewport` | Two-dimensional clipping/panning over any child view |
| [`Scrollbar`](https://github.com/everruns/tuika/blob/v0.12.0/docs/components/layout.md#scrollbar--virtualwindow) / `VirtualWindow` | Reusable bars and clamped ranges for virtualized collections |
| `Form` / `FormField` (+ `FormState`) | Responsive labeled controls and validation |
| `DrawView` / `CanvasView` | Closure-based custom cell drawing |
| [`SelectList`](https://github.com/everruns/tuika/blob/v0.12.0/docs/components/interactive.md#selectlist--selectstate) (+ `SelectState`) | Selectable list, including host-windowed collections |
| [`TreeList`](https://github.com/everruns/tuika/blob/v0.12.0/docs/components/interactive.md#treelist--treestate) (+ `TreeState`) | Stable-id expandable tree over host-provided rows |
| [`SelectionScreen`](https://github.com/everruns/tuika/blob/v0.12.0/docs/components/layout.md#selectionscreen) | Responsive full-screen action/agent/permission pickers |
| [`KeyedTable`](https://github.com/everruns/tuika/blob/v0.12.0/docs/components/interactive.md#keyedtable--keyedselectstate) (+ keyed single/multi-selection) | Borrowed, virtualized slice or projected rows whose selection follows stable application keys |
| [`CompletionPalette`](https://github.com/everruns/tuika/blob/v0.12.0/docs/components/interactive.md#completionpalette--completionstate) (+ `CompletionState`, `CompletionItem`) | Filter-ranked command and token completion |
| `Slider` (+ `SliderState`) | One-row value picker over a numeric range |
| [`TextInput`](https://github.com/everruns/tuika/blob/v0.12.0/docs/components/interactive.md#textinput--textinputstate) (+ `TextInputState`) | Multi-line composer: soft-wrap, placeholder, highlighted ranges, `@`/`/` tokens |
| [`StatusBar`](https://github.com/everruns/tuika/blob/v0.12.0/docs/components/layout.md#statusbar) | One-row left/right status segments |
| [`Tabs`](https://github.com/everruns/tuika/blob/v0.12.0/docs/components/interactive.md#tabs--tabsstate) / `KeyHints` | Host-state tab navigation and command hints |
...
| [`Spinner`](https://github.com/everruns/tuika/blob/v0.12.0/docs/components/motion.md#spinner) | Frame-cycled activity glyph |
| [`ProgressBar`](https://github.com/everruns/tuika/blob/v0.12.0/docs/components/motion.md#progressbar) | Determinate (sub-cell) / indeterminate bar |
| [`ActivityList`](https://github.com/everruns/tuika/blob/v0.12.0/docs/components/motion.md#activitylist) | Multi-step lifecycle status with optional per-step progress |
| [`Loader`](https://github.com/everruns/tuika/blob/v0.12.0/docs/components/motion.md#loader) | Spinner + message + hint row |
...
the [`Html`](https://github.com/everruns/tuika/blob/v0.12.0/docs/components/markdown-code.md#html) component for markup that is not inside
markdown at all. See the markdown guide for
[inline HTML](https://github.com/everruns/tuika/blob/v0.12.0/docs/markdown.md#inline-html) and
[block HTML](https://github.com/everruns/tuika/blob/v0.12.0/docs/markdown.md#block-html).
...
See the [theme gallery](https://github.com/everruns/tuika/blob/v0.12.0/docs/themes.md) for a screenshot of each bundled
...
[inheriting the terminal's colors](https://github.com/everruns/tuika/blob/v0.12.0/docs/features.md#inheriting-the-terminals-colors).
...
model. See the [styling guide](https://github.com/everruns/tuika/blob/v0.12.0/docs/styling.md). `StyleBundle::padding` is layout, not a
...
The [screen-modes guide](https://github.com/everruns/tuika/blob/v0.12.0/docs/features.md#screen-modes-alternate-screen--split-footer)
...
See the [showcases](https://github.com/everruns/tuika/blob/v0.12.0/docs/showcases.md) for a recording of each. Building
...
- [`tuika-html`](crates/tuika-html/) lays out block-level HTML with html5ever —
  ...
  through its own [`Html`](https://github.com/everruns/tuika/blob/v0.12.0/docs/components/markdown-code.md#html) component.
